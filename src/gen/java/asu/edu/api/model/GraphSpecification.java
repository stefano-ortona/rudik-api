...
public class GraphSpecification   {
  ...
  **/
   ...
   * @return targetPrefix
  **/
  @ApiModelProperty(value = "If specified, all relations used in the mining must start with this prefix.")
  ...
  **/
   ...
   * @return typePrefix
  **/
  @ApiModelProperty(value = "Relation prefixes to be used as type for entities.")
