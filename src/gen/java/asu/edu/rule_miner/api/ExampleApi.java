...
public class ExampleApi  {
   private final ExampleApiService delegate = ExampleApiServiceFactory.getExampleApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Positive and Negative Example Generation", notes = "Generate positive and negative examples for the given target predicate. If types of subject and/or object are not specified, then the most common ones from the graph will be used.", response = RuleExample.class, tags={ "example", })
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "The input rule specification is not valid.", response = RuleExample.class),
