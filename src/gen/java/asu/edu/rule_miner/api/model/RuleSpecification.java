...
public class RuleSpecification {
   ...
   **/
  @ApiModelProperty(required = true, value = "Array of target predicates to use as target predicates for the mining.")
   ...
   * @return coverBound
   **/
  @ApiModelProperty(value = "If set to a positive number greater than 0, then the endpoint will return the first coverBound number of rules, independently from the set cover. If set to a negative number or 0, the endpoint will return all the output rules independently from the set cover. If not set, the normal set cover algorithm will be run.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final RuleSpecification ruleSpecification = (RuleSpecification) o;
    return Objects.equals(this.id, ruleSpecification.id)
        && Objects.equals(this.targetRelation, ruleSpecification.targetRelation)
        && Objects.equals(this.type, ruleSpecification.type) && Objects.equals(this.graph, ruleSpecification.graph)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, targetRelation, type, graph, maxLength, subjectType, objectType, positiveExamples,
        negativeExamples, resultEndpoint, metadata);
  }
