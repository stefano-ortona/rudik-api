...
public class GraphSpecification   {
  ...
  **/
   ...
   * @return targetPrefix
  **/
  @ApiModelProperty(example = "null", value = "If specified, all relations used in the mining must start with one of these prefixes.")
  ...
  **/
   ...
   * @return typePrefix
  **/
  @ApiModelProperty(example = "null", value = "Relation to be used as type-relation when discovering types for entities.")
  ...
  **/
   ...
   * @return genericType
  **/
  @ApiModelProperty(example = "null", value = "Generic abstract type to avoid when computing subject and object most common types for a given target predicate.")
